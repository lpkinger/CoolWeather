...
import com.example.lpkinger.coolweather.gson.Forecast;
import com.example.lpkinger.coolweather.gson.Weather;
import com.example.lpkinger.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView titlrUpdateTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titlrUpdateTime=(TextView)findViewById(R.id.title_update_time);
    ...
    private void showWeatherInfo(Weather weather){
        ...
        titlrUpdateTime.setText(updateTime);
        degreeText.setText(degree);
        weatherInfoText.setText(weatherInfo);
        forecastLayout.removeAllViews();
        for (Forecast forecast:weather.forecastList){
            View view=LayoutInflater.from(this).inflate(R.layout.forecast_item,forecastLayout,false);
            TextView dateText=(TextView)view.findViewById(R.id.dete_text);
